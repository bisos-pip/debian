...
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.b.clsMethod_csu | bisos.debian.configFile | bisos.debian.bifSystemd_csu | plantedCsu |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.b.clsMethod_csu', 'bisos.debian.configFile', 'bisos.debian.bifSystemd_csu', 'plantedCsu', ]
...
####+BEGINNOT: b:py3:cs:main/exposedSymbols :classes ("bifSystemd_csu.configFile_sysdUnit")
""" #+begin_org
